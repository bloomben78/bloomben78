...
- 💡 Engineering: Quantitative Finance, Local LLM deployment & Automated Financial Pipelines
...
![Simulation GBM](https://raw.githubusercontent.com/bloomben78/test/master/quant_banner_v5.gif)

## Tech Stack

![Python](https://img.shields.io/badge/Python-0D1117?style=flat-square&logo=python&logoColor=white)
![R](https://img.shields.io/badge/R-0D1117?style=flat-square&logo=r&logoColor=white)
...
![SciPy](https://img.shields.io/badge/SciPy-0D1117?style=flat-square&logo=scipy&logoColor=white)
...
![XGBoost](https://img.shields.io/badge/XGBoost-0D1117?style=flat-square&logo=xgboost&logoColor=white)
![MLflow](https://img.shields.io/badge/MLflow-0D1117?style=flat-square&logo=mlflow&logoColor=white)
...
![Apache Spark](https://img.shields.io/badge/Spark-0D1117?style=flat-square&logo=apachespark&logoColor=white)
...
![TradingView](https://img.shields.io/badge/TradingView-0D1117?style=flat-square&logo=tradingview&logoColor=white)
...
| Domain | Skills |
|---|---|
| **Quantitative Finance** | Derivatives pricing · Monte Carlo simulation · Stochastic calculus · Time-series modeling (ARIMA, GARCH) |
| **Risk Management** | VaR / CVaR · Credit risk modeling · Stress testing · Basel III framework |
| **Portfolio Management** | Mean-variance optimization · Factor models · Backtesting · Performance attribution |
| **Machine Learning** | PyTorch · TensorFlow · Keras · scikit-learn · XGBoost · MLflow |
| **LLM & AI Engineering** | LangChain · LangGraph · RAG pipelines · Local LLM deployment (Ollama, llama.cpp) · Prompt engineering |
| **Data Engineering** | NumPy · pandas · SciPy · statsmodels · PostgreSQL · Apache Spark |
| **Trading** | MQL4 / MQL5 · Pine Script · Backtrader · Market data APIs |
| **Delivery & Visualization** | Streamlit · R Shiny · Power BI · Docker · Jupyter · LaTeX |
